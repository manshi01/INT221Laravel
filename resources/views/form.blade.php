...
<head>
  ...
  <title>DevBlog - Manshi Bharti's Personal Blog</title>
    ...
    <div class="hero">
      ...
      <div class="container">
        ...
        <div class="right">
          ...
          <div class="img-box">
          <img src="{{ URL('assets/images/cartoon.jpg') }}" alt="Manshi Bharti" class="hero-img">
          ...
          <div class="blog-card-group">
            ...
            <div class="blog-card">
              ...
              <div class="blog-card-banner">
                <img src="./assets/images/blog1.png" alt="Building microservices with Dropwizard, MongoDB & Docker"
                  width="250" class="blog-banner-img">
              </div>

              <div class="blog-content-wrapper">

                <button class="blog-topic text-tiny">SKIN CARE</button>

                <h3>
                  <a href="https://healthcareandskin.blogspot.com/2021/11/natural-beauty-work-workshop-natural.html" class="h3">
                  Natural Beauty Work Workshop
                  </a>
                </h3>

                <p class="blog-text">
                Natural Beauty Workshop, as its name implies,
                is a wealth of information on how to make your own skin care products at 
                home using natural and non-toxic natural ingredients.
                </p>

                <div class="wrapper-flex">

                  <div class="profile-wrapper">
                    <img src="assets/images/cartoon.jpg" alt="Manshi Bharti" width="50">
                  </div>
            ...
            <div class="blog-card">
              ...
              <div class="blog-card-banner">
                <img src="./assets/images/blog2.jpeg" alt="Fast web page loading on a $20 feature phone" width="250"
                  class="blog-banner-img">
              </div>

              <div class="blog-content-wrapper">

                <button class="blog-topic text-tiny">Natural Skin Care</button>

                <h3><a href="https://healthcareandskin.blogspot.com/2021/11/how-to-live-preetynaturally.html" class="h3"> Living Well, Naturally</a></h3>

                <p class="blog-text">
                Living Pretty, Naturally is the mind of Kate, who loves to try new beauty products and knows her way through skin care. On her blog,
                 you find not only reviews of beauty products but also links where you can buy natural makeup.
                </p>
            ...
            <div class="blog-card">
              ...
              <div class="blog-card-banner">
                <img src="./assets/images/blog3.jpg" alt="Accessibility Tips for Web Developers" width="250"
                  class="blog-banner-img">
              </div>

              <div class="blog-content-wrapper">

                <button class="blog-topic text-tiny">Reduce Wrinkles</button>

                <h3><a href="https://healthcareandskin.blogspot.com/2021/11/what-causes-wrinkles.html" class="h3"> Reduce the Appearance of Wrinkles</a></h3>

                <p class="blog-text">
                November 01, 2021 // by Health and Skin care // 

Fine lines and wrinkles are often the result of aging. As we grow older, 
the collagen and elastin in our skin break down. Both collagen and elastin
 are an important part of skin health and provide make-up to help keep it looking smooth and fresh
                </p>
